                    ...
                    <div className="mb-8 p-4 bg-white/5 border border-white/10 rounded-xl">
                        ...
                        {displayProfile.lastLogin && (
                            <div className="flex items-center gap-3 mt-4">
                                <Icon name="spark" className="h-5 w-5 text-gray-400" />
                                <div>
                                    <div className="text-xs text-gray-500 uppercase font-bold tracking-wider">Last Login</div>
                                    <div className="text-sm text-white font-medium">
                                        {new Date(displayProfile.lastLogin.seconds * 1000).toLocaleString()}
                                    </div>
                                </div>
                            </div>
                        )}
