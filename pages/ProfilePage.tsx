                    ...
                    {isOwnProfile ? (
                        <div className="space-y-6">
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Instagram Handle</label>
                                    <div className="relative">
                                        <Icon name="instagram" className="absolute left-4 top-3.5 text-pink-500 h-5 w-5" />
                                        <input
                                            value={editInstagram}
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-6 border-t border-white/5 mt-6">
                                <div className="bg-black/20 p-4 rounded-xl text-center">
                                    <div className="text-2xl font-bold text-white">{joinedGroups.length}</div>
                                    <div className="text-xs text-gray-500 uppercase">Groups</div>
                                </div>
                                <div className="bg-black/20 p-4 rounded-xl text-center">
                                    <div className="text-2xl font-bold text-white">{displayProfile.createdAt ? new Date(displayProfile.createdAt).getFullYear() : '2024'}</div>
                                    <div className="text-xs text-gray-500 uppercase">Joined</div>
                                </div>
                                <div className="bg-black/20 p-4 rounded-xl text-center">
                                    <div className="text-2xl font-bold text-white">{displayProfile.followersCount || 0}</div>
                                    <div className="text-xs text-gray-500 uppercase">Followers</div>
                                </div>
                                <div className="bg-black/20 p-4 rounded-xl text-center">
                                    <div className="text-2xl font-bold text-white">{displayProfile.followingCount || 0}</div>
